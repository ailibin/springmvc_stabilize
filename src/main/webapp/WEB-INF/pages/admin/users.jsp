...
<body>
<div class="container">
    <h1 class="text-success">SpringMVC 博客系统-用户管理</h1>
    <jsp:include page="canvasTime.jsp"/>
    <hr/>
    ...
    <!-- 如果用户列表非空 -->
    <c:if test="${!empty userList}">
        <!--条纹状表格和带边框表格共存,鼠标悬停(table-hover)-->
        <table class="table table-bordered table-striped table-hover">
            ...
            <c:forEach items="${userList}" var="user">
                <tr>
                    ...
                    <td>
                        <img src=${pageContext.request.contextPath}/${user.avatar} width="50px" height="50px" class="img-circle"/>
                    </td>
                </tr>
            </c:forEach>
        </table>
